...
while line:
    ...
    if line_nr > 1 :
        ...
        print(str(line_nr))
        cur.execute("INSERT INTO public.conflicten(id, geom, landnaam, conflictnaam, jaartal, aantal_doden, waar_land) VALUES (%s, ST_SetSRID(ST_MakePoint(%s, %s),4326), %s, %s, %s, %s, %s )",(id, x, y, landnaam, conflictnaam, jaartal, aantal_doden, waar_land ))
        # Commit
        conn.commit()
